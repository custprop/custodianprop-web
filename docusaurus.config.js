...
const config = {
  ...
  projectName: 'Custodian Prop - Web', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/custprop',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Custodian Prop, Inc. Built with Docusaurus.`,
      },
      prism: {
